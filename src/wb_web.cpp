...
<div id='paused-banner' style='display:none;background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.35);border-radius:10px;padding:12px 14px;margin-bottom:10px;color:#f59e0b;font-size:.88em;line-height:1.4'>&#x23F8;&#xFE0F; <strong>Schedules &amp; Eco Smart paused</strong> — manual control is active. Press Start to resume.</div>
